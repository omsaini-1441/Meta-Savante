...
import Undraw from "../../assets/website/undraw-top.png"
import UndrawD from "../../assets/website/undraw-down.png"
...
const SignUp = () => {
        ...
        <div className="container">
          ...
          <div className=" justify-items-center place-items-center min-h-[850px]  ">
            <motion.div
             ...
             className="pt-[40px] ">
              <h1
            className="text-lightOrange text-center pt-6 text-3xl font-semibold uppercase ">Elevate Your <span className="text-primary ">Influence</span>
            </h1>
            </motion.div>
            ...
            <div className=" relative z-40 max-w-lg mx-auto my-10 p-6 bg-white shadow-md rounded-lg">
              ...
              className="text-2xl font-bold mb-6 text-center uppercase">
                <span className="text-darkGray">Influencer </span><span className="text-primary uppercase ">Sign-Up</span>
              </motion.h2>
  ...
  <label className="block text-sm font-medium text-darkGray">Followers Count</label>
  <input
    {...register('followerCount', {
      required: 'Followers count is required*',
      pattern: {
        value: /^[0-9]+$/,
        message: 'Followers count must be a number*',
      },
      validate: value => (parseInt(value, 10) > 0) || 'Followers count must be greater than 0*',
    })}
    className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-md focus:ring-orange-500 focus:border-orange-500"
    type="text"
    placeholder="Enter your follower count"
  />
  {errors.followerCount && <p className="text-primaryDark text-sm mt-1">{errors.followerCount.message}</p>}
</motion.div>
                ...
                >
                  ...
                  <textarea
                    {...register("audienceDescription", {
                      required: "Audience Description is required*",
                    })}
                    className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-md focus:ring-primary focus:border-primary"
                    rows="4"
                    placeholder="Describe your what type of audience you cater or from where"
                  ></textarea>
            ...
            <motion.div
                                      ...
                                      className='h-[220px] w-[240px] absolute top-[-2.5rem] -right-[-17rem]
                                      ...
                                      className='h-[220px] w-[240px] absolute -top-[-18rem] -left-[-15rem]
                                      border-primary border-none rounded-full z-10 '>
                                          <img src={UndrawD} alt="" />
                                      </motion.div>
            </div>
